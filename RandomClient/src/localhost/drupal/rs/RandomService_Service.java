 ...
 * 2020-06-04T11:49:07.764+01:00
 * Generated source version: 2.7.18
 * 
 */
@WebServiceClient(name = "RandomService", 
                  wsdlLocation = "file:src/main/resources/RandomService.wsdl",
...
public class RandomService_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:src/main/resources/RandomService.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(RandomService_Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:src/main/resources/RandomService.wsdl");
        }
        WSDL_LOCATION = url;
    }
